# This process consisting of 2 functions. The first function
...
# 
# The next section defines the four key elements 9or behaviors: the "getters"
# and "setters". The set code/definition accepts an argument named y.
#
